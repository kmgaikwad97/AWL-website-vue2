...
<div>
    ...
    <div class="our-service-img">
        <img src="../assets/images/beskitchen.jpg" class="image-size" alt="" />
    </div>
    <div class="container">
        <br />
        <div class="homecontent">
            <p class="paracontent" style="
            text-align: center;
            width: 80%;
            margin: 0 auto;
            font-size: 20px;
    ...
    <!-- img 2 -->
    <div class="our-service-img">
        <img src="../assets/images/beskitchen1.jpg" class="image-size" alt="" />
    </div>
    <div class="container">
        <br />
        <div class="homecontent">
